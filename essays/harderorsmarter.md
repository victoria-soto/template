...
<p>“In English, it’s much easier to say ‘There are three tall men’ than ‘There is a tall man, a tall man, and a tall man’. This means that in Bootstrap, to achieve a thing (say a navbar), we need to have 2-3 nested classes of “navbar”, ”navbar-default”, etc. whereas with Semantic UI, it can be done with single one.”</p><footer class="blockquote-footer">Found in <cite title="Choosing Semantic UI over Bootstrap for the Open Even Front-end">opntec.org</cite><footer><./blockquote>
